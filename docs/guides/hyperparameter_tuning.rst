...
- Small datasets: Use smaller hidden sizes (
- Complex tasks: Try larger sizes (
                                ...
                                for hidden_size in params['hidden_size']::
                                    for num_layers in params['num_layers']::
                                        ...
                                        def sample_params(
                                            ...
                                            return {
                                            'hidden_size': np.random.choice(
                                            'num_layers': np.random.choice(
                                            'backbone_dropout': np.random.uniform(
                                            'learning_rate': np.random.loguniform(
