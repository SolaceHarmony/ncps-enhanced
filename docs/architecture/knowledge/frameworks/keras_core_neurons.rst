...
NCPS provides two core neuron types implemented as Keras cells: 1. CfC
(Closed-form Continuous-time) 2. LTC (Linear Time-invariant
Continuous-time)

Both follow Keras conventions while providing unique continuous-time
