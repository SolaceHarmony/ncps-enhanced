...
This document demonstrates how our TensorAbstraction documentation would
look when converted to Sphinx RST format.
...
This example demonstrates how our existing markdown documentation can be
enhanced using Sphinx’s RST features while maintaining clarity and
organization.
