"""Liquid Time-Constant (LTC) RNN implementation for Keras."""
...
class LTC(keras.Model):
    """A Liquid Time-Constant (LTC) RNN layer.
    
    This layer wraps the LTCCell with sequence processing capabilities
