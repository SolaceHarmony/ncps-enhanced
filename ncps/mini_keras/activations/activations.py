...
@keras_mini_export("ncps.mini_keras.activations.relu")
...
@keras_mini_export("ncps.mini_keras.activations.leaky_relu")
...
@keras_mini_export("ncps.mini_keras.activations.relu6")
def relu6(x):
...
@keras_mini_export("ncps.mini_keras.activations.softmax")
...
@keras_mini_export("ncps.mini_keras.activations.elu")
def elu(x, alpha=1.0):
...
@keras_mini_export("ncps.mini_keras.activations.selu")
def selu(x):
...
@keras_mini_export("ncps.mini_keras.activations.softplus")
def softplus(x):
...
@keras_mini_export("ncps.mini_keras.activations.softsign")
def softsign(x):
...
@keras_mini_export("ncps.mini_keras.activations.soft_shrink")
...
@keras_mini_export("ncps.mini_keras.activations.sparse_plus")
def sparse_plus(x):
...
@keras_mini_export(["ncps.mini_keras.activations.silu", "ncps.mini_keras.activations.swish"])
def silu(x):
...
@keras_mini_export("ncps.mini_keras.activations.squareplus")
...
@keras_mini_export("ncps.mini_keras.activations.gelu")
...
@keras_mini_export("ncps.mini_keras.activations.celu")
...
@keras_mini_export("ncps.mini_keras.activations.glu")
def glu(x, axis=-1):
...
@keras_mini_export("ncps.mini_keras.activations.tanh")
def tanh(x):
...
@keras_mini_export("ncps.mini_keras..activations.hard_tanh")
def hard_tanh(x):
...
@keras_mini_export("ncps.mini_keras.activations.hard_shrink")
...
@keras_mini_export("ncps.mini_keras.activations.threshold")
...
@keras_mini_export("ncps.mini_keras.activations.sigmoid")
def sigmoid(x):
...
@keras_mini_export("ncps.mini_keras.activations.exponential")
def exponential(x):
...
@keras_mini_export("ncps.mini_keras.activations.hard_sigmoid")
def hard_sigmoid(x):
...
@keras_mini_export("ncps.mini_keras.activations.log_sigmoid")
def log_sigmoid(x):
...
@keras_mini_export(["ncps.mini_keras.activations.hard_silu", "ncps.mini_keras.activations.hard_swish"])
def hard_silu(x):
...
@keras_mini_export("ncps.mini_keras.activations.linear")
def linear(x):
...
@keras_mini_export("ncps.mini_keras.activations.mish")
def mish(x):
...
@keras_mini_export("ncps.mini_keras.activations.log_softmax")
...
@keras_mini_export(["ncps.mini_keras.activations.sparsemax"])
