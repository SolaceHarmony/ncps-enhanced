...
@keras_mini_export("ncps.mini_keras._legacy.backend.abs")
def abs(x):
    """DEPRECATED."""
    return tf.abs(x)


@keras_mini_export("ncps.mini_keras._legacy.backend.all")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.any")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.argmax")
def argmax(x, axis=-1):
    """DEPRECATED."""
    return tf.argmax(x, axis)


@keras_mini_export("ncps.mini_keras._legacy.backend.argmin")
def argmin(x, axis=-1):
    """DEPRECATED."""
    return tf.argmin(x, axis)


@keras_mini_export("ncps.mini_keras._legacy.backend.arange")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.batch_dot")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.batch_flatten")
def batch_flatten(x):
    """DEPRECATED."""
...
@keras_mini_export("ncps.mini_keras._legacy.backend.batch_get_value")
def batch_get_value(tensors):
    """DEPRECATED."""
    return [x.numpy() for x in tensors]


@keras_mini_export("ncps.mini_keras._legacy.backend.batch_set_value")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.batch_normalization")
def batch_normalization(x, mean, var, beta, gamma, axis=-1, epsilon=1e-3):
    """DEPRECATED."""
    return tf.nn.batch_normalization(x, mean, var, beta, gamma, epsilon)


@keras_mini_export("ncps.mini_keras._legacy.backend.bias_add")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.binary_crossentropy")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.binary_focal_crossentropy")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.cast")
def cast(x, dtype):
    """DEPRECATED."""
    return tf.cast(x, dtype)


@keras_mini_export("ncps.mini_keras._legacy.backend.cast_to_floatx")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.categorical_crossentropy")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.categorical_focal_crossentropy")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.clip")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.concatenate")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.constant")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.conv1d")
def conv1d(
...
@keras_mini_export("ncps.mini_keras._legacy.backend.conv2d")
def conv2d(
    x,
    kernel,
    strides=(1, 1),
...
@keras_mini_export("ncps.mini_keras._legacy.backend.conv2d_transpose")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.conv3d")
def conv3d(
    x,
    kernel,
    strides=(1, 1, 1),
...
@keras_mini_export("ncps.mini_keras._legacy.backend.cos")
def cos(x):
    """DEPRECATED."""
    return tf.cos(x)


@keras_mini_export("ncps.mini_keras._legacy.backend.count_params")
def count_params(x):
    """DEPRECATED."""
    return np.prod(x.shape.as_list())


@keras_mini_export("ncps.mini_keras._legacy.backend.ctc_batch_cost")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.ctc_label_dense_to_sparse")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.ctc_decode")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.cumsum")
def cumsum(x, axis=0):
    """DEPRECATED."""
    return tf.cumsum(x, axis=axis)


@keras_mini_export("ncps.mini_keras._legacy.backend.cumprod")
def cumprod(x, axis=0):
    """DEPRECATED."""
    return tf.math.cumprod(x, axis=axis)


@keras_mini_export("ncps.mini_keras._legacy.backend.depthwise_conv2d")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.dot")
def dot(x, y):
    """DEPRECATED."""
...
@keras_mini_export("ncps.mini_keras._legacy.backend.dropout")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.dtype")
def dtype(x):
    """DEPRECATED."""
    return x.dtype.base_dtype.name


@keras_mini_export("ncps.mini_keras._legacy.backend.elu")
def elu(x, alpha=1.0):
    """DEPRECATED."""
    res = tf.nn.elu(x)
    if alpha == 1:
...
@keras_mini_export("ncps.mini_keras._legacy.backend.equal")
def equal(x, y):
    """DEPRECATED."""
    return tf.equal(x, y)


@keras_mini_export("ncps.mini_keras._legacy.backend.eval")
def eval(x):
    """DEPRECATED."""
    return get_value(to_dense(x))


@keras_mini_export("ncps.mini_keras._legacy.backend.exp")
def exp(x):
    """DEPRECATED."""
    return tf.exp(x)


@keras_mini_export("ncps.mini_keras._legacy.backend.expand_dims")
def expand_dims(x, axis=-1):
    """DEPRECATED."""
    return tf.expand_dims(x, axis)


@keras_mini_export("ncps.mini_keras._legacy.backend.eye")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.flatten")
def flatten(x):
    """DEPRECATED."""
    return tf.reshape(x, [-1])


@keras_mini_export("ncps.mini_keras._legacy.backend.foldl")
def foldl(fn, elems, initializer=None, name=None):
    """DEPRECATED."""
    return tf.compat.v1.foldl(fn, elems, initializer=initializer, name=name)


@keras_mini_export("ncps.mini_keras._legacy.backend.foldr")
def foldr(fn, elems, initializer=None, name=None):
    """DEPRECATED."""
    return tf.compat.v1.foldr(fn, elems, initializer=initializer, name=name)


@keras_mini_export("ncps.mini_keras._legacy.backend.gather")
def gather(reference, indices):
    """DEPRECATED."""
    return tf.compat.v1.gather(reference, indices)


@keras_mini_export("ncps.mini_keras._legacy.backend.get_value")
def get_value(x):
    """DEPRECATED."""
...
@keras_mini_export("ncps.mini_keras._legacy.backend.gradients")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.greater")
def greater(x, y):
    """DEPRECATED."""
    return tf.greater(x, y)


@keras_mini_export("ncps.mini_keras._legacy.backend.greater_equal")
def greater_equal(x, y):
    """DEPRECATED."""
    return tf.greater_equal(x, y)


@keras_mini_export("ncps.mini_keras._legacy.backend.hard_sigmoid")
def hard_sigmoid(x):
    """DEPRECATED."""
...
@keras_mini_export("ncps.mini_keras._legacy.backend.in_top_k")
def in_top_k(predictions, targets, k):
    """DEPRECATED."""
    return tf.compat.v1.math.in_top_k(predictions, targets, k)


@keras_mini_export("ncps.mini_keras._legacy.backend.int_shape")
def int_shape(x):
    """DEPRECATED."""
    try:
        shape = x.shape
...
@keras_mini_export("ncps.mini_keras._legacy.backend.is_sparse")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.l2_normalize")
def l2_normalize(x, axis=None):
    """DEPRECATED."""
    return tf.linalg.l2_normalize(x, axis=axis)


@keras_mini_export("ncps.mini_keras._legacy.backend.less")
def less(x, y):
    """DEPRECATED."""
    return tf.less(x, y)


@keras_mini_export("ncps.mini_keras._legacy.backend.less_equal")
def less_equal(x, y):
    """DEPRECATED."""
    return tf.less_equal(x, y)


@keras_mini_export("ncps.mini_keras._legacy.backend.log")
def log(x):
    """DEPRECATED."""
    return tf.math.log(x)


@keras_mini_export("ncps.mini_keras._legacy.backend.map_fn")
def map_fn(fn, elems, name=None, dtype=None):
    """DEPRECATED."""
    return tf.compat.v1.map_fn(fn, elems, name=name, dtype=dtype)


@keras_mini_export("ncps.mini_keras._legacy.backend.max")
def max(x, axis=None, keepdims=False):
    """DEPRECATED."""
    return tf.reduce_max(x, axis, keepdims)


@keras_mini_export("ncps.mini_keras._legacy.backend.maximum")
def maximum(x, y):
    """DEPRECATED."""
    return tf.maximum(x, y)


@keras_mini_export("ncps.mini_keras._legacy.backend.mean")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.min")
def min(x, axis=None, keepdims=False):
    """DEPRECATED."""
    return tf.reduce_min(x, axis, keepdims)


@keras_mini_export("ncps.mini_keras._legacy.backend.minimum")
def minimum(x, y):
    """DEPRECATED."""
    return tf.minimum(x, y)


@keras_mini_export("ncps.mini_keras._legacy.backend.moving_average_update")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.name_scope")
def name_scope(name):
    """DEPRECATED."""
    return tf.name_scope(name)


@keras_mini_export("ncps.mini_keras._legacy.backend.ndim")
def ndim(x):
    """DEPRECATED."""
    return x.shape.rank


@keras_mini_export("ncps.mini_keras._legacy.backend.not_equal")
def not_equal(x, y):
    """DEPRECATED."""
    return tf.not_equal(x, y)


@keras_mini_export("ncps.mini_keras._legacy.backend.one_hot")
def one_hot(indices, num_classes):
    """DEPRECATED."""
    return tf.one_hot(indices, depth=num_classes, axis=-1)


@keras_mini_export("ncps.mini_keras._legacy.backend.ones")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.ones_like")
def ones_like(x, dtype=None, name=None):
    """DEPRECATED."""
    return tf.ones_like(x, dtype=dtype, name=name)


@keras_mini_export("ncps.mini_keras._legacy.backend.permute_dimensions")
def permute_dimensions(x, pattern):
    """DEPRECATED."""
    return tf.transpose(x, perm=pattern)


@keras_mini_export("ncps.mini_keras._legacy.backend.pool2d")
def pool2d(
    x,
    pool_size,
    strides=(1, 1),
...
@keras_mini_export("ncps.mini_keras._legacy.backend.pool3d")
def pool3d(
    x,
    pool_size,
    strides=(1, 1, 1),
...
@keras_mini_export("ncps.mini_keras._legacy.backend.pow")
def pow(x, a):
    """DEPRECATED."""
    return tf.pow(x, a)


@keras_mini_export("ncps.mini_keras._legacy.backend.prod")
def prod(x, axis=None, keepdims=False):
    """DEPRECATED."""
    return tf.reduce_prod(x, axis, keepdims)


@keras_mini_export("ncps.mini_keras._legacy.backend.random_bernoulli")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.random_normal")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.random_normal_variable")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.random_uniform")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.random_uniform_variable")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.reshape")
def reshape(x, shape):
    """DEPRECATED."""
    return tf.reshape(x, shape)


@keras_mini_export("ncps.mini_keras._legacy.backend.relu")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.repeat")
def repeat(x, n):
    """DEPRECATED."""
    assert ndim(x) == 2
    x = tf.expand_dims(x, 1)
...
@keras_mini_export("ncps.mini_keras._legacy.backend.repeat_elements")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.resize_images")
def resize_images(
...
@keras_mini_export("ncps.mini_keras._legacy.backend.resize_volumes")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.reverse")
def reverse(x, axes):
    """DEPRECATED."""
    if isinstance(axes, int):
        axes = [axes]
...
@keras_mini_export("ncps.mini_keras._legacy.backend.rnn")
def rnn(
    step_function,
    inputs,
    initial_states,
...
@keras_mini_export("ncps.mini_keras._legacy.backend.round")
def round(x):
    """DEPRECATED."""
    return tf.round(x)


@keras_mini_export("ncps.mini_keras._legacy.backend.separable_conv2d")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.set_value")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.shape")
def shape(x):
    """DEPRECATED."""
    return tf.shape(x)


@keras_mini_export("ncps.mini_keras._legacy.backend.sigmoid")
def sigmoid(x):
    """DEPRECATED."""
    output = tf.sigmoid(x)
    return output
...
@keras_mini_export("ncps.mini_keras._legacy.backend.sign")
def sign(x):
    """DEPRECATED."""
    return tf.sign(x)


@keras_mini_export("ncps.mini_keras._legacy.backend.sin")
def sin(x):
    """DEPRECATED."""
    return tf.sin(x)


@keras_mini_export("ncps.mini_keras._legacy.backend.softmax")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.softplus")
def softplus(x):
    """DEPRECATED."""
    return tf.math.softplus(x)


@keras_mini_export("ncps.mini_keras._legacy.backend.softsign")
def softsign(x):
    """DEPRECATED."""
    return tf.math.softsign(x)


@keras_mini_export("ncps.mini_keras._legacy.backend.sparse_categorical_crossentropy")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.spatial_2d_padding")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.spatial_3d_padding")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.sqrt")
def sqrt(x):
    """DEPRECATED."""
...
@keras_mini_export("ncps.mini_keras._legacy.backend.square")
def square(x):
    """DEPRECATED."""
    return tf.square(x)


@keras_mini_export("ncps.mini_keras._legacy.backend.squeeze")
def squeeze(x, axis):
    """DEPRECATED."""
    return tf.squeeze(x, [axis])


@keras_mini_export("ncps.mini_keras._legacy.backend.stack")
def stack(x, axis=0):
    """DEPRECATED."""
    return tf.stack(x, axis=axis)


@keras_mini_export("ncps.mini_keras._legacy.backend.std")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.stop_gradient")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.sum")
def sum(x, axis=None, keepdims=False):
    """DEPRECATED."""
    return tf.reduce_sum(x, axis, keepdims)


@keras_mini_export("ncps.mini_keras._legacy.backend.switch")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.tanh")
def tanh(x):
    """DEPRECATED."""
    return tf.tanh(x)


@keras_mini_export("ncps.mini_keras._legacy.backend.temporal_padding")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.tile")
def tile(x, n):
    """DEPRECATED."""
    if isinstance(n, int):
        n = [n]
...
@keras_mini_export("ncps.mini_keras._legacy.backend.to_dense")
def to_dense(tensor):
    """DEPRECATED."""
    if is_sparse(tensor):
...
@keras_mini_export("ncps.mini_keras._legacy.backend.transpose")
def transpose(x):
    """DEPRECATED."""
    return tf.transpose(x)


@keras_mini_export("ncps.mini_keras._legacy.backend.truncated_normal")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.update")
def update(x, new_x):
    """DEPRECATED."""
    return tf.compat.v1.assign(x, new_x)


@keras_mini_export("ncps.mini_keras._legacy.backend.update_add")
def update_add(x, increment):
    """DEPRECATED."""
    return tf.compat.v1.assign_add(x, increment)


@keras_mini_export("ncps.mini_keras._legacy.backend.update_sub")
def update_sub(x, decrement):
    """DEPRECATED."""
    return tf.compat.v1.assign_sub(x, decrement)


@keras_mini_export("ncps.mini_keras._legacy.backend.var")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.variable")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.zeros")
...
@keras_mini_export("ncps.mini_keras._legacy.backend.zeros_like")
