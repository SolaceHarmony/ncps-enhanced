...
@keras_mini_export(
    [
        "ncps.mini_keras.legacy.saving.serialize_keras_object",
        "ncps.mini_keras.utils.legacy.serialize_keras_object",
    ]
)
...
@keras_mini_export(
    [
        "ncps.mini_keras.legacy.saving.deserialize_keras_object",
        "ncps.mini_keras.utils.legacy.deserialize_keras_object",
    ]
)
    ...
    if isinstance(identifier, dict):
        ...
        if hasattr(cls, "from_config"):
            ...
            cls_config = _find_replace_nested_dict(
                cls_config, "ncps.mini_keras.", "ncps.mini_keras."
            )
