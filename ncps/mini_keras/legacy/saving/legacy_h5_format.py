...
from ncps.mini_keras.legacy.saving import json_utils
from ncps.mini_keras.legacy.saving import saving_options
...
def save_weights_to_hdf5_group(f, model):
    ...
    """
    from ncps.mini_keras import __version__ as keras_version
