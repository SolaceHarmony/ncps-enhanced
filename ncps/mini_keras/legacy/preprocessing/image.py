...
@keras_mini_export("ncps.mini_keras._legacy.preprocessing.image.Iterator")
...
@keras_mini_export("ncps.mini_keras._legacy.preprocessing.image.DirectoryIterator")
...
@keras_mini_export("ncps.mini_keras._legacy.preprocessing.image.NumpyArrayIterator")
...
@keras_mini_export("ncps.mini_keras._legacy.preprocessing.image.ImageDataGenerator")
...
@keras_mini_export("ncps.mini_keras._legacy.preprocessing.image.random_rotation")
def random_rotation(
    x,
    rg,
    row_axis=1,
...
@keras_mini_export("ncps.mini_keras._legacy.preprocessing.image.random_shift")
def random_shift(
    x,
    wrg,
    hrg,
...
@keras_mini_export("ncps.mini_keras._legacy.preprocessing.image.random_shear")
def random_shear(
    x,
    intensity,
    row_axis=1,
...
@keras_mini_export("ncps.mini_keras._legacy.preprocessing.image.random_zoom")
def random_zoom(
    x,
    zoom_range,
    row_axis=1,
...
@keras_mini_export("ncps.mini_keras._legacy.preprocessing.image.apply_channel_shift")
...
@keras_mini_export("ncps.mini_keras._legacy.preprocessing.image.random_channel_shift")
...
@keras_mini_export("ncps.mini_keras._legacy.preprocessing.image.apply_brightness_shift")
...
@keras_mini_export("ncps.mini_keras._legacy.preprocessing.image.random_brightness")
...
@keras_mini_export("ncps.mini_keras._legacy.preprocessing.image.apply_affine_transform")
