...
@keras_mini_export("ncps.mini_keras._legacy.preprocessing.sequence.TimeseriesGenerator")
...
@keras_mini_export("ncps.mini_keras._legacy.preprocessing.sequence.make_sampling_table")
...
@keras_mini_export("ncps.mini_keras._legacy.preprocessing.sequence.skipgrams")
def skipgrams(
    sequence,
    vocabulary_size,
    window_size=4,
