...
@keras_mini_export("ncps.mini_keras._legacy.preprocessing.text.text_to_word_sequence")
...
@keras_mini_export("ncps.mini_keras._legacy.preprocessing.text.one_hot")
def one_hot(
    input_text,
    n,
    filters='!"#$%&()*+,-./:;<=>?@[\\]^_`{|}~\t\n',
...
@keras_mini_export("ncps.mini_keras._legacy.preprocessing.text.hashing_trick")
def hashing_trick(
    text,
    n,
    hash_function=None,
...
@keras_mini_export("ncps.mini_keras._legacy.preprocessing.text.Tokenizer")
class Tokenizer:
    """DEPRECATED."""
...
@keras_mini_export("ncps.mini_keras._legacy.preprocessing.text.tokenizer_from_json")
