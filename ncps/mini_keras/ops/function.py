...
@keras_mini_export("ncps.mini_keras.Function")
class Function(Operation):
    ...
    ```python
    input_1 = ncps.mini_keras.KerasTensor(shape=(None, 2, 3))
    input_2 = ncps.mini_keras.KerasTensor(shape=(None, 2, 3))
    x = input_1 + input_2
    output = ncps.mini_keras.ops.sigmoid(x)
    fn = ncps.mini_keras.Function(inputs=[input_1, input_2], outputs=output)
    ...
    def __init__(self, inputs, outputs, name=None):
        ...
        if backend() == "tensorflow":
            ...
            # https://github.com/ncps.mini_keras-team/ncps.mini_keras/issues/931
...
def _build_map(inputs, outputs):
    ...
    Returns:
        ...
        ordered_nodes: list of nodes appearing in the ncps.mini_keras history,
