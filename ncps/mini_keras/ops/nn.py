...
from ncps.mini_keras.backend import standardize_data_format
...
@keras_mini_export(["ncps.mini_keras.ops.relu", "ncps.mini_keras.ops.nn.relu"])
def relu(x):
...
@keras_mini_export(["ncps.mini_keras.ops.relu6", "ncps.mini_keras.ops.nn.relu6"])
def relu6(x):
...
@keras_mini_export(["ncps.mini_keras.ops.sigmoid", "ncps.mini_keras.ops.nn.sigmoid"])
def sigmoid(x):
...
@keras_mini_export(["ncps.mini_keras.ops.softplus", "ncps.mini_keras.ops.nn.softplus"])
def softplus(x):
...
@keras_mini_export(["ncps.mini_keras.ops.softsign", "ncps.mini_keras.ops.nn.softsign"])
def softsign(x):
...
@keras_mini_export(["ncps.mini_keras.ops.soft_shrink", "ncps.mini_keras.ops.nn.soft_shrink"])
...
@keras_mini_export(["ncps.mini_keras.ops.sparse_plus", "ncps.mini_keras.ops.nn.sparse_plus"])
def sparse_plus(x):
...
@keras_mini_export(
    [
        "ncps.mini_keras.ops.silu",
        "ncps.mini_keras.ops.nn.silu",
        "ncps.mini_keras.ops.swish",
        "ncps.mini_keras.ops.nn.swish",
    ]
)
def silu(x):
...
@keras_mini_export(["ncps.mini_keras.ops.squareplus", "ncps.mini_keras.ops.nn.squareplus"])
...
@keras_mini_export(
    [
        "ncps.mini_keras.ops.log_sigmoid",
        "ncps.mini_keras.ops.nn.log_sigmoid",
    ]
)
def log_sigmoid(x):
...
@keras_mini_export(["ncps.mini_keras.ops.leaky_relu", "ncps.mini_keras.ops.nn.leaky_relu"])
...
@keras_mini_export(
    [
        "ncps.mini_keras.ops.hard_sigmoid",
        "ncps.mini_keras.ops.nn.hard_sigmoid",
    ]
)
def hard_sigmoid(x):
...
@keras_mini_export(
    [
        "ncps.mini_keras.ops.hard_silu",
        "ncps.mini_keras.ops.nn.hard_silu",
        "ncps.mini_keras.ops.hard_swish",
        "ncps.mini_keras.ops.nn.hard_swish",
    ]
)
def hard_silu(x):
...
@keras_mini_export(["ncps.mini_keras.ops.elu", "ncps.mini_keras.ops.nn.elu"])
def elu(x, alpha=1.0):
...
@keras_mini_export(["ncps.mini_keras.ops.selu", "ncps.mini_keras.ops.nn.selu"])
def selu(x):
...
@keras_mini_export(["ncps.mini_keras.ops.gelu", "ncps.mini_keras.ops.nn.gelu"])
...
@keras_mini_export(["ncps.mini_keras.ops.celu", "ncps.mini_keras.ops.nn.celu"])
...
@keras_mini_export(["ncps.mini_keras.ops.glu", "ncps.mini_keras.ops.nn.glu"])
def glu(x, axis=-1):
...
@keras_mini_export(["ncps.mini_keras.ops.tanh_shrink", "ncps.mini_keras.ops.nn.tanh_shrink"])
def tanh_shrink(x):
...
@keras_mini_export(["ncps.mini_keras.ops.hard_tanh", "ncps.mini_keras.ops.nn.hard_tanh"])
def hard_tanh(x):
...
@keras_mini_export(["ncps.mini_keras.ops.hard_shrink", "ncps.mini_keras.ops.nn.hard_shrink"])
...
@keras_mini_export(["ncps.mini_keras.ops.threshold", "ncps.mini_keras.ops.nn.threshold"])
...
@keras_mini_export(["ncps.mini_keras.ops.softmax", "ncps.mini_keras.ops.nn.softmax"])
...
@keras_mini_export(
    [
        "ncps.mini_keras.ops.log_softmax",
        "ncps.mini_keras.ops.nn.log_softmax",
    ]
)
...
@keras_mini_export(["ncps.mini_keras.ops.sparsemax", "ncps.mini_keras.ops.nn.sparsemax"])
...
@keras_mini_export(["ncps.mini_keras.ops.max_pool", "ncps.mini_keras.ops.nn.max_pool"])
def max_pool(
    inputs,
    pool_size,
    strides=None,
...
@keras_mini_export(
    [
        "ncps.mini_keras.ops.average_pool",
        "ncps.mini_kerasas.ops.nn.average_pool",
    ]
)
def average_pool(
    inputs,
...
@keras_mini_export(["ncps.mini_keras.ops.conv", "ncps.mini_keras.ops.nn.conv"])
def conv(
    inputs,
    kernel,
    strides=1,
...
@keras_mini_export(
    [
        "ncps.mini_keras.ops.depthwise_conv",
        "ncps.mini_keras.ops.nn.depthwise_conv",
    ]
)
def depthwise_conv(
    inputs,
...
@keras_mini_export(
    [
        "ncps.mini_keras.ops.separable_conv",
        "ncps.mini_keras.ops.nn.separable_conv",
    ]
)
def separable_conv(
    inputs,
...
@keras_mini_export(
    [
        "ncps.mini_keras.ops.conv_transpose",
        "ncps.mini_keras.ops.nn.conv_transpose",
    ]
)
def conv_transpose(
    inputs,
...
@keras_mini_export(["ncps.mini_keras.ops.one_hot", "ncps.mini_keras.ops.nn.one_hot"])
...
@keras_mini_export(
    [
        "ncps.mini_keras.ops.binary_crossentropy",
        "ncps.mini_keras.ops.nn.binary_crossentropy",
    ]
)
...
@keras_mini_export(
    [
        "ncps.mini_keras.ops.categorical_crossentropy",
        "ncps.mini_keras.ops.nn.categorical_crossentropy",
    ]
)
...
@keras_mini_export(
    [
        "ncps.mini_keras.sparse_categorical_crossentropy",
        "ncps.mini_keras.nn.sparse_categorical_crossentropy",
    ]
)
...
@keras_mini_export(
    [
        "ncps.mini_keras.ops.multi_hot",
        "ncps.mini_keras.ops.nn.multi_hot",
    ]
)
def multi_hot(
...
@keras_mini_export(
    [
        "ncps.mini_keras.ops.moments",
        "ncps.mini_keras.ops.nn.moments",
    ]
)
...
@keras_mini_export(
    [
        ...
        "ncps.mini_keras.ops.nn.batch_normalization",
    ]
)
...
@keras_mini_export(
    [
        "ncps.mini_keras.ops.ctc_loss",
        "ncps.mini_keras.ops.nn.ctc_loss",
    ]
)
...
@keras_mini_export(
    [
        "ncps.mini_keras.ops.ctc_decode",
        "ncps.mini_keras.ops.nn.ctc_decode",
    ]
)
def ctc_decode(
    inputs,
...
@keras_mini_export(
    [
        "ncps.mini_keras.ops.normalize",
        "ncps.mini_keras.ops.nn.normalize",
    ]
)
...
@keras_mini_export(
    [
        "ncps.mini_keras.ops.psnr",
        "ncps.mini_keras.ops.nn.psnr",
    ]
)
def psnr(
    x1,
...
@keras_mini_export(
    ["ncps.mini_keras.ops.dot_product_attention", "ncps.mini_keras.ops.nn.dot_product_attention"]
)
