...
@keras_mini_export("ncps.mini_keras.ops.segment_sum")
...
@keras_mini_export("ncps.mini_keras.ops.segment_max")
...
@keras_mini_export("ncps.mini_keras.ops.top_k")
...
@keras_mini_export("ncps.mini_keras.ops.in_top_k")
...
@keras_mini_export("ncps.mini_keras.ops.logsumexp")
...
@keras_mini_export("ncps.mini_keras.ops.extract_sequences")
...
@keras_mini_export("ncps.mini_keras.ops.fft")
def fft(x):
...
@keras_mini_export("ncps.mini_keras.ops.fft2")
def fft2(x):
...
@keras_mini_export("ncps.mini_keras.ops.ifft2")
def ifft2(x):
...
@keras_mini_export("ncps.mini_keras.ops.rfft")
...
@keras_mini_export("ncps.mini_keras.ops.irfft")
...
@keras_mini_export("ncps.mini_keras.ops.stft")
def stft(
...
@keras_mini_export("ncps.mini_keras.ops.istft")
def istft(
    x,
    sequence_length,
    sequence_stride,
...
@keras_mini_export("ncps.mini_keras.ops.rsqrt")
def rsqrt(x):
...
@keras_mini_export("ncps.mini_keras.ops.erf")
def erf(x):
...
@keras_mini_export("ncps.mini_keras.ops.erfinv")
def erfinv(x):
...
@keras_mini_export(["ncps.mini_keras.ops.logdet"])
def logdet(x):
