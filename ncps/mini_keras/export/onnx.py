...
from ncps.mini_keras.export.saved_model import DEFAULT_ENDPOINT_NAME
from ncps.mini_keras.export.saved_model import ExportArchive
from ncps.mini_keras.export.tf2onnx_lib import patch_tf2onnx
...
def export_onnx(model, filepath, verbose=True, input_signature=None, **kwargs):
    ...
    **Note:** The dynamic shape feature is not yet supported with Torch
    ...
    if backend.backend() in ("tensorflow", "jax"):
        from ncps.mini_keras.utils.module_utils import tf2onnx
