...
@keras_mini_export(["ncps.mini_keras.initializers.Constant", "ncps.mini_keras.initializers.constant"])
...
@keras_mini_export(["ncps.mini_keras.initializers.Zeros", "ncps.mini_keras.initializers.zeros"])
...
@keras_mini_export(["ncps.mini_keras.initializers.Ones", "ncps.mini_keras.initializers.ones"])
...
@keras_mini_export(
    [
        "ncps.mini_keras.initializers.Identity",
        "ncps.mini_keras.initializers.identity",
        "ncps.mini_keras.initializers.IdentityInitializer",
    ]
)
...
@keras_mini_export(
    [
        "ncps.mini_keras.initializers.STFT",
        "ncps.mini_keras.initializers.stft",
        "ncps.mini_keras.initializers.STFTInitializer",
    ]
)
