...
@keras_mini_export("ncps.mini_keras.constraints.Constraint")
class Constraint:
    ...
    >>> class NonNegative(ncps.mini_keras.constraints.Constraint):
    ...
    ...  def __call__(self, w):
...
@keras_mini_export(["ncps.mini_keras.constraints.MaxNorm", "ncps.mini_keras.constraints.max_norm"])
...
@keras_mini_export(["ncps.mini_keras.constraints.NonNeg", "ncps.mini_keras.constraints.non_neg"])
...
@keras_mini_export(["ncps.mini_keras.constraints.UnitNorm", "ncps.mini_keras.constraints.unit_norm"])
...
@keras_mini_export(
    ["ncps.mini_keras.constraints.MinMaxNorm", "ncps.mini_keras.constraints.min_max_norm"]
)
