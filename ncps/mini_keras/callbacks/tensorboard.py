...
from ncps.mini_keras.layers import Embedding
from ncps.mini_keras.optimizers import Optimizer
from ncps.mini_keras.utils import file_utils


@keras_mini_export("ncps.mini_keras.callbacks.TensorBoard")
    ...
    * Sampled profiling
    ...
    def summary(self):
        if self._summary_module is None:
            import tensorflow.summary as summary # type: ignore
...
def keras_model_summary(name, data, step=None):
    ...
    """
    import tensorflow.summary as summary # type: ignore
    from tensorflow.compat.v1 import SummaryMetadata # type: ignore
