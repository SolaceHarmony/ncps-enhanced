...
@keras_mini_export(
    [
        "ncps.mini_keras.layers.rnn.DTypePolicy",
        "ncps.mini_keras.layers.rnn.dtype_policies.DTypePolicy",
        "ncps.mini_keras.layers.rnn.mixed_precision.DTypePolicy",  # Legacy
        "ncps.mini_keras.layers.rnn.mixed_precision.Policy",  # Legacy
    ]
)
class DTypePolicy:
...
@keras_mini_export(
    ["ncps.mini_keras.layers.rnn.FloatDTypePolicy", "ncps.mini_keras.layers.rnn.dtype_policies.FloatDTypePolicy"]
)
...
@keras_mini_export("ncps.mini_keras.layers.rnn.dtype_policies.QuantizedDTypePolicy")
...
@keras_mini_export("ncps.mini_keras.layers.rnn.dtype_policies.QuantizedFloat8DTypePolicy")
...
@keras_mini_export(
    [
        "ncps.mini_keras.layers.rnn.config.set_dtype_policy",
        "ncps.mini_keras.layers.rnn.mixed_precision.set_dtype_policy",  # Legacy
        "ncps.mini_keras.layers.rnn.mixed_precision.set_global_policy",  # Legacy
    ]
)
def set_dtype_policy(policy):
    ...
    >>> ncps.mini_keras.layers.rnn.config.set_dtype_policy("mixed_float16")
    """
...
@keras_mini_export(
    [
        "ncps.mini_keras.layers.rnn.config.dtype_policy",
        "ncps.mini_keras.layers.rnn.mixed_precision.dtype_policy",  # Legacy
        "ncps.mini_keras.layers.rnn.mixed_precision.global_policy",  # Legacy
    ]
)
def dtype_policy():
