...
from ncps.mini_keras.dtype_policies import dtype_policy
from ncps.mini_keras.dtype_policies.dtype_policy import QUANTIZATION_MODES
from ncps.mini_keras.dtype_policies.dtype_policy import DTypePolicy
from ncps.mini_keras.dtype_policies.dtype_policy import FloatDTypePolicy
from ncps.mini_keras.dtype_policies.dtype_policy import QuantizedDTypePolicy
from ncps.mini_keras.dtype_policies.dtype_policy import QuantizedFloat8DTypePolicy
from ncps.mini_keras.dtype_policies.dtype_policy_map import DTypePolicyMap
...
@keras_mini_export("ncps.mini_keras.dtype_policies.serialize")
...
@keras_mini_export("ncps.mini_keras.dtype_policies.deserialize")
...
@keras_mini_export("ncps.mini_keras.dtype_policies.get")
def get(identifier):
    ...
    Returns:
        A Keras `DTypePolicy` instance.
    """
    from ncps.mini_keras.dtype_policies.dtype_policy import (
