...
from ncps.mini_keras.datasets.cifar import load_batch
from ncps.mini_keras.utils.file_utils import get_file


@keras_mini_export("ncps.mini_keras.datasets.cifar100.load_data")
def load_data(label_mode="fine"):
    ...
    **`y_test`**: `uint8` NumPy array of labels (integers in range 0-99)
    ...
    ```python
    (x_train, y_train), (x_test, y_test) = ncps.mini_keras.datasets.cifar100.load_data()
