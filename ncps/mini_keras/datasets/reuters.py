...
@keras_mini_export("ncps.mini_keras.datasets.reuters.load_data")
def load_data(
    path="reuters.npz",
    num_words=None,
    skip_top=0,
...
@keras_mini_export("ncps.mini_keras.datasets.reuters.get_word_index")
...
@keras_mini_export("ncps.mini_keras.datasets.reuters.get_label_names")
def get_label_names():
