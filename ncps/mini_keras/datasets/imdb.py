...
from ncps.mini_keras.utils.python_utils import remove_long_seq


@keras_mini_export("ncps.mini_keras.datasets.imdb.load_data")
def load_data(
    path="imdb.npz",
    num_words=None,
    skip_top=0,
...
@keras_mini_export("ncps.mini_keras.datasets.imdb.get_word_index")
