...
from ncps.mini_keras.backend.common.global_state import get_global_attribute
from ncps.mini_keras.backend.common.global_state import set_global_attribute
