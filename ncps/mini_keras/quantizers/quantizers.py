...
@keras_mini_export(["ncps.mini_keras.Quantizer", "ncps.mini_keras.quantizers.Quantizer"])
class Quantizer:
...
@keras_mini_export("ncps.mini_keras.quantizers.abs_max_quantize")
...
@keras_mini_export("ncps.mini_keras.quantizers.AbsMaxQuantizer")
...
@keras_mini_export("ncps.mini_keras.quantizers.fake_quant_with_min_max_vars_per_channel")
...
@keras_mini_export("ncps.mini_keras.quantizers.compute_float8_scale")
...
@keras_mini_export("ncps.mini_keras.quantizers.compute_float8_amax_history")
...
@keras_mini_export("ncps.mini_keras.quantizers.quantize_and_dequantize")
