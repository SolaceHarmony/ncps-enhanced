...
from ncps.mini_keras.layers.convolutional.base_depthwise_conv import BaseDepthwiseConv


@keras_mini_export("ncps.mini_keras.layers.DepthwiseConv2D")
class DepthwiseConv2D(BaseDepthwiseConv):
    ...
    >>> y = ncps.mini_keras.layers.DepthwiseConv2D(kernel_size=3, activation='relu')(x)
    >>> print(y.shape)
    (4, 8, 8, 12)
    """
