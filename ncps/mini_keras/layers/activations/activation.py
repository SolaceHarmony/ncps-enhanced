...
@keras_mini_export("ncps.mini_keras.layers.Activation")
class Activation(Layer):
    ...
    >>> layer = ncps.mini_keras.layers.Activation('relu')
    >>> layer(np.array([-3.0, -1.0, 0.0, 2.0]))
    [0.0, 0.0, 0.0, 2.0]
    >>> layer = ncps.mini_keras.layers.Activation(keras.activations.relu)
    >>> layer(np.array([-3.0, -1.0, 0.0, 2.0]))
    [0.0, 0.0, 0.0, 2.0]
    """
