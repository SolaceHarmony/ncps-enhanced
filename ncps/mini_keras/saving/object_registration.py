...
@keras_mini_export(
    [
        "ncps.mini_keras.saving.CustomObjectScope",
        "ncps.mini_keras.saving.custom_object_scope",
        "ncps.mini_keras.utils.CustomObjectScope",
        "ncps.mini_keras.utils.custom_object_scope",
    ]
)
...
@keras_mini_export(
    [
        "ncps.mini_keras.saving.get_custom_objects",
        "ncps.mini_keras.utils.get_custom_objects",
    ]
)
...
@keras_mini_export(
    [
        "ncps.mini_keras.saving.register_keras_serializable",
        "ncps.mini_keras.utils.register_keras_serializable",
    ]
)
...
@keras_mini_export(
    [
        "ncps.mini_keras.saving.get_registered_name",
        "ncps.mini_keras.utils.get_registered_name",
    ]
)
...
@keras_mini_export(
    [
        "ncps.mini_keras.saving.get_registered_object",
        "ncps.mini_keras.utils.get_registered_object",
    ]
)
def get_registered_object(name, custom_objects=None, module_objects=None):
    ...
    def from_config(cls, config, custom_objects=None):
        if 'my_custom_object_name' in config:
            config['hidden_cls'] = tf.ncps.mini_keras.saving.get_registered_object(
