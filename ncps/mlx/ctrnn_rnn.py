"""Continuous-Time Recurrent Neural Network (CTRNN) RNN implementation."""
...
class CTRNN(LiquidRNN):
    """A Continuous-Time Recurrent Neural Network (CTRNN) layer."""
    ...
    def __call__(
        ...
        """Process a sequence through the CTRNN network.
